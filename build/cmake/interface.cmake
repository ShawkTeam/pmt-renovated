...
if(ANDROID_NATIVE_API_LEVEL LESS_EQUAL 23)
    target_compile_definitions(pmt_interface_shared INTERFACE _FILE_OFFSET_BITS=32)
    target_compile_options(pmt_interface_shared INTERFACE -Wno-macro-redefined)
    target_compile_definitions(pmt_interface_static INTERFACE _FILE_OFFSET_BITS=32)
    target_compile_options(pmt_interface_static INTERFACE -Wno-macro-redefined)
    target_compile_definitions(pmt_interface_nolibs INTERFACE _FILE_OFFSET_BITS=32)
    target_compile_options(pmt_interface_nolibs INTERFACE -Wno-macro-redefined)
    target_compile_definitions(pmt_interface_nolibs_and_flags INTERFACE _FILE_OFFSET_BITS=32)
    target_compile_options(pmt_interface_nolibs_and_flags INTERFACE -Wno-macro-redefined)
endif()

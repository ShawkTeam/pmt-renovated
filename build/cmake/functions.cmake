...
function(add_super_library TARGET_NAME)
    ...
    if(ARG_LINKER_SCRIPT)
        target_link_options(${SHARED_TARGET} PRIVATE "-Wl,-T,${ARG_LINKER_SCRIPT}")
    endif()
endfunction()

function(add_plugin PLUGIN_NAME)
    set(options DISABLE NO_MODULE_LINKER_SCRIPT)
    set(oneValueArgs LINKER_SCRIPT)
